...
# Title of page
st.title("AUC Translator")

# Use columns to reduce width of input box
col1, col2, col3 = st.columns(3)
with col1:
    hex_val = st.text_input("Please enter a 2 Byte AUC value:",
...
df = pd.read_csv('files/auc_map.csv')
...
if hex_input != "0000":
    st.write("")
    st.write("")
    st.write("The following AUC bits are set to True in this transaction:")
