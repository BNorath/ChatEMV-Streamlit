...
# Title of page
st.title("AIP Translator")

# Use columns to reduce width of input box
col1, col2, col3 = st.columns(3)
with col1:
    hex_val = st.text_input("Please enter a 2 Byte AIP value:",
...
df = pd.read_csv('files/aip_map.csv')
...
if hex_input != "0000":
    st.write("")
    st.write("")
    st.write("The following AIP bits are set to True in this transaction:")
...
if hex_input != "0000":
    st.subheader("In simpler terms, the following settings are configured to "
                 "True on the card:")
